<%-- 
    Document   : pblood
    Created on : Jun 19, 2019, 1:54:54 PM
    Author     : pc
--%>
	    ...
	    <div class="container d-flex align-items-center">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav mr-auto">
	        	<li class="nav-item active"><a href="pblood1.jsp" class="nav-link pl-0">HOME</a></li>
	        	...
	        	<li class="nav-item"><a href="VIEWDOCTOR.jsp" class="nav-link">DOCTORS</a></li>
	        	 ...
	        	 <li class="nav-item"><a href="pblood1.jsp" class="nav-link">BLOOD BANK</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread"> VIEW BLOOD</h1>
            <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>VIEW BLOOD<i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
