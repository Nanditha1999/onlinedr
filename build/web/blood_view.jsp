...
<html lang="en">
	    ...
	    <div class="container d-flex align-items-center">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav mr-auto">
	        	<!--<li class="nav-item active"><a href="VIEWDOCTOR.jsp" class="nav-link pl-0">HOME</a></li>
	        	<li class="nav-item"><a href="APP.html" class="nav-link">VIEW APPOINTMENT</a></li>
	        	<li class="nav-item"><a href="cancelapp.html" class="nav-link">CANCEL APPOINTMENT</a></li>
                        ...
                        <li class="nav-item active"><a href="blood_view.jsp" class="nav-link pl-0">HOME</a></li>
	        	...
	        	<li class="nav-item"><a href="VIEWDOCTOR.jsp" class="nav-link">DOCTORS</a></li>
                          <li class="nav-item"><a href="prescription.html" class="nav-link">PRESCRIPTION</a></li>
	        	 <li class="nav-item"><a href="blood_view.jsp" class="nav-link">BLOOD BANK</a></li>
                          <li class="nav-item"><a href="pricing.html" class="nav-link">PAYMENT</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">BLOOD VIEW</h1>
  ...
  <% while(rs.next())
  {
      %>
      <tr><td>
              <% out.print(rs.getString("blood_group"));%> </td> 
          <td> <% out.print(rs.getString("availability"));%></td>
           </tr>
  <%}
  %> </table>
