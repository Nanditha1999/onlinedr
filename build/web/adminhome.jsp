<%-- 
    Document   : adminhome
    Created on : Jun 18, 2019, 10:57:02 AM
    Author     : pc
--%>
	    ...
	    <div class="container d-flex align-items-center">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav mr-auto">
	        	<li class="nav-item active"><a href="adminhome.jsp" class="nav-link pl-0">HOME</a></li>
	        	<li class="nav-item"><a href="NEWDOCTOR.html" class="nav-link">NEW DOCTOR</a></li>
	        	<li class="nav-item"><a href="VIEWDOCTOR1.jsp" class="nav-link">VIEW DOCTORS</a></li>
                        <li class="nav-item"><a href="BLOODBANK.html" class="nav-link">BLOOD BANK</a></li>
                         <li class="nav-item"><a href="admin.html" class="nav-link">LOGOUT</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">ADMIN HOME</h1>
            <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>ADMIN HOME<i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
