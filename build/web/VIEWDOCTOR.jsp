...
<html lang="en">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav mr-auto">
	        	...
	        	<li class="nav-item"><a href="VIEWDOCTOR.jsp" class="nav-link">DOCTORS</a></li>
                          <li class="nav-item"><a href="prescription.html" class="nav-link">PRESCRIPTION</a></li>
	        	 <li class="nav-item"><a href="pblood.jsp" class="nav-link">BLOOD BANK</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">VIEW DOCTOR</h1>
  ...
  <% while(rs.next())
  {
      ...
      <tr><td>
          ...
          <td> <% out.print(rs.getString("working_hospital"));%></td>
          <td> <% out.print(rs.getString("specialization"));%></td>
          <td> <% out.print(rs.getString("year_of_experience"));%></td>
          <td> <% out.print(rs.getString("qualification"));%></td>
          <td> <% out.print(rs.getString("fee"));%></td>
                    <td> <% out.print(rs.getString("skypid"));%></td>
