<%-- 
    Document   : cancelapp
    Created on : Jun 19, 2019, 2:21:35 PM
    Author     : pc
--%>
...
<html lang="en">
    ...
    <nav class="navbar py-4 navbar-expand-lg ftco_navbar navbar-light bg-light flex-row">
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container d-flex align-items-center">
	      ...
	      <p class="button-custom order-lg-last mb-0"><a href="appointment.html" class="btn btn-secondary py-2 px-3">Cancel Appointment</a></p>
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav mr-auto">
	        	<li class="nav-item active"><a href="cancelapp.jsp" class="nav-link pl-0">HOME</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">Cancel Appointment</h1>
            <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home <i class="ion-ios-arrow-forward"></i></a></span> <span> Cancel Appointment <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section> 
  ...
  <% while(rs.next())
  {
      %>
      <tr><td>
              <% out.print(rs.getString("patient_number"));%> </td> 
          <td> <% out.print(rs.getString("name"));%></td>
          <td> <% out.print(rs.getString("gender"));%></td>
          <td> <% out.print(rs.getString("age"));%></td>
          <td> <% out.print(rs.getString("mobile_number"));%></td>
          <td> <% out.print(rs.getString("doctor"));%></td>
          <td> <% out.print(rs.getString("date"));%></td>
          <td> <a href="cancel.jsp?id=<%out.print(rs.getString("patient_number")); %>">Cancel</a></td>
