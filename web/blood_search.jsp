...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="css/style.css">
        ...
        {
         var x=document.forms["form1"]["BLOOD"];
           if(x.value=="")
           {
        ...
        var x=document.forms["form1"]["AVAILABILITY"];
           if(x.value=="")
           {
               document.getElementById('AVAILABILITY').innerHTML="HOW MUCH YOU NEED";
               x.focus();
               return false;
           } 
  ...
  <body>
	    ...
	    <div class="container d-flex align-items-center">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav mr-auto">
	        	<li class="nav-item active"><a href="blood_search.jsp" class="nav-link pl-0">HOME</a></li>
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/bg_1.jpg');" data-stellar-background-ratio="0.5">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">BLOOD BANK</h1>
            <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>BLOOD<i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
	 <section class="ftco-section ftco-no-pt ftco-no-pb contact-section">
			<div class="container">
                            <BR><BR>
                            <form name="form1" method="post" action="blood_view.jsp" >   
